...
public class TestProcessActions extends TestCase {
	...
	public void testLogAccesso() throws BusinessException {
	...
	/**
	 * Nessun name query definito e nessun name query da testare
	 */
	public void testHelloWorldUtentiConnessi() {
		try {

			List<VUtentiLoggatiDettaglio> result = appservice.getUtentiConnessi();
